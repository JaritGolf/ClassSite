...
export function PauseBanner({ pausePointMinutes }: PauseBannerProps) {
  ...
  return (
    <div
      role="status"
      aria-live="polite"
      className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 flex items-center gap-3 rounded-2xl border-b-4 border-indigo-900 bg-indigo-700 px-5 py-3 text-white shadow-card animate-pop-in"
    >
